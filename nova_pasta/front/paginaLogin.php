				...
				<div class="card-body">
					<form method="post" action="../control/controleUsuario.php">
						...
						<div class="form-group">
							<input type="submit" name="opcao" value="Entrar" class="btn float-right login_btn">
						</div>
					</form>
				</div>
				<div class="card-footer">
					<div class="d-flex justify-content-center links">Não possui uma conta?<a
							href="cadastrarUsuario.php">Cadastre-se!</a>
					</div>
				</div>
			</div>
		</div>
